...
async function main() {
    ...
    const standardSchedule = await prisma.workingSchedule.create({
        data: {
            ...
            type: client_1.ScheduleType.STANDARD,
                ...
                create: [
                    {
                        name: 'Basic Salary',
                        code: 'BASIC',
                        category: client_1.RuleCategory.BASIC,
                        sequence: 10,
                        calculationType: client_1.RuleCalcType.PERCENTAGE,
                    ...
                    },
                    {
                        ...
                        code: 'HRA',
                        category: client_1.RuleCategory.ALLOWANCE,
                        sequence: 20,
                        calculationType: client_1.RuleCalcType.PERCENTAGE,
                        value: '0.40 * BASIC',
                        condition: 'True',
                    ...
                    },
                    {
                        ...
                        category: client_1.RuleCategory.ALLOWANCE,
                        sequence: 30,
                        calculationType: client_1.RuleCalcType.FIXED,
                        value: '5000',
                        condition: 'True',
                        status: 'Active',
                    },
                    ...
                    },
                    {
                        ...
                        code: 'PF',
                        category: client_1.RuleCategory.DEDUCTION,
                        sequence: 40,
                        calculationType: client_1.RuleCalcType.PERCENTAGE,
                        value: '0.12 * BASIC',
                        condition: 'True',
                    ...
                    },
                    {
                        name: 'Net Salary',
                        code: 'NET',
                        category: client_1.RuleCategory.NET,
                        sequence: 60,
                        calculationType: client_1.RuleCalcType.FORMULA,
    ...
    const aarav = await prisma.employee.create({
        data: {
            ...
            employeeType: client_1.EmployeeType.FULL_TIME,
    ...
    await prisma.user.createMany({
        data: [
            ...
            },
            {
                ...
                password: passwordHash,
                role: client_1.Role.HR_PAYROLL_USER,
            },
            {
                name: 'Meera Joshi',
                email: 'payroll.manager@peoplepay360.com',
                password: passwordHash,
                role: client_1.Role.HR_PAYROLL_MANAGER,
            },
            {
                name: 'Aarav Sharma',
                email: 'aarav.sharma@peoplepay360.com',
    ...
    await prisma.contract.create({
        data: {
            ...
            status: client_1.ContractStatus.EXPIRED,
        },
    });
    ...
    await prisma.timeOffRequest.create({
        data: {
            ...
            status: client_1.TimeOffStatus.APPROVED,
        },
    });
    await prisma.timeOffRequest.create({
        data: {
